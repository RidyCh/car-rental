<div>
    ...
    {{-- MODAL FORM --}}
    <x-modal wire:model="modalForm" class="backdrop-blur" title="Perbarui Pembayaran">
        <x-form wire:submit.prevent="save">
            <x-input type="number" label="Jumlah yang harus dibayar" wire:model="form.price" step="0.01" readonly>
