                ...
                <div class="flex flex-wrap justify-center mb-12 -mx-3">
                    ...
                    <div class="w-full p-3 md:w-6/12 lg:w-4/12">
                        <div class="text-gray-500 bg-white border shadow-md">
                            <a href="#"><img
                                    ...
                                    class="w-full hover:opacity-90" alt="..." width="600"
                                    height="450" /></a>
                            <div class="p-6">
                                <h4 class="mb-2 text-xl font-bold text-gray-900"><a href="#"
                                        class="hover:text-gray-500">Hyundai Creta 2017</a></h4>
                                ...
                                <div class="flex items-center justify-between">
                                    <div class="inline-flex items-center py-1 space-x-1">
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                            fill="currentColor" width="1.125em" height="1.125em"
                    ...
                    <div class="w-full p-3 md:w-6/12 lg:w-4/12">
                        <div class="text-gray-500 bg-white border shadow-md">
                            ...
                            <div class="p-6">
                                <h4 class="mb-2 text-xl font-bold text-gray-900"><a href="#"
                                        class="hover:text-gray-500">Honda Accord 2018</a></h4>
                                <p class="mb-2 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <hr class="my-4 border-gray-200">
                                <div class="flex items-center justify-between">
                                    <div class="inline-flex items-center py-1 space-x-1">
                    ...
                    <div class="w-full p-3 md:w-6/12 lg:w-4/12">
                        <div class="text-gray-500 bg-white border shadow-md">
                            ...
                            <div class="p-6">
                                <h4 class="mb-2 text-xl font-bold text-gray-900"><a href="#"
                                        class="hover:text-gray-500">BMW M3 2010</a></h4>
                                <p class="mb-2 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <hr class="my-4 border-gray-200">
                                <div class="flex items-center justify-between">
                                    <div class="inline-flex items-center py-1 space-x-1">
                    ...
                    <div class="w-full p-3 md:w-6/12 lg:w-4/12">
                        <div class="text-gray-500 bg-white border shadow-md">
                            ...
                            <div class="p-6">
                                <h4 class="mb-2 text-xl font-bold text-gray-900"><a href="#"
                                        class="hover:text-gray-500">Chevrolet Equinox 2005</a></h4>
                                <p class="mb-2 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <hr class="my-4 border-gray-200">
                                <div class="flex items-center justify-between">
                                    <div class="inline-flex items-center py-1 space-x-1">
                    ...
                    <div class="w-full p-3 md:w-6/12 lg:w-4/12">
                        <div class="text-gray-500 bg-white border shadow-md">
                            ...
                            <div class="p-6">
                                <h4 class="mb-2 text-xl font-bold text-gray-900"><a href="#"
                                        class="hover:text-gray-500">Ferrari 458 Spider 2015</a></h4>
                                <p class="mb-2 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <hr class="my-4 border-gray-200">
                                <div class="flex items-center justify-between">
                                    <div class="inline-flex items-center py-1 space-x-1">
                    ...
                    <div class="w-full p-3 md:w-6/12 lg:w-4/12">
                        <div class="text-gray-500 bg-white border shadow-md">
                            ...
                            <div class="p-6">
                                <h4 class="mb-2 text-xl font-bold text-gray-900"><a href="#"
                                        class="hover:text-gray-500">Ford Mustang Shelby 2017</a></h4>
                                <p class="mb-2 text-sm">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
                                <hr class="my-4 border-gray-200">
                                <div class="flex items-center justify-between">
                                    <div class="inline-flex items-center py-1 space-x-1">
